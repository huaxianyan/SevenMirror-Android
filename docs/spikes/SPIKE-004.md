...
- validate Android process restart and interrupted-network recovery over the connected synthetic relay session; exact duplicate and Chrome Worker restart are now manually validated
