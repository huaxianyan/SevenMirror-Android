...
- validate interrupted-network recovery over the connected synthetic relay session; exact duplicate plus Chrome Worker and Android process restarts are now manually validated
