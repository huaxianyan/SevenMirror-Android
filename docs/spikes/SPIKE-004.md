...
- validate Worker/process restart and interrupted-network recovery over the connected synthetic relay session; exact duplicate invoke/result execute-once is now manually validated
