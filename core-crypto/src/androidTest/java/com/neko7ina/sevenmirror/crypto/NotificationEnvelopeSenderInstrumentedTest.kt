...
class NotificationEnvelopeSenderInstrumentedTest {
    ...
    fun appNotificationIsIndependentlyEncryptedForEveryRosterRecipient() {
        ...
        try {
            ...
            assertFalse(frames.any { it.toString(Charsets.UTF_8).contains("com.neko7ina.sevenmirror") })
            ...
            assertEquals("com.neko7ina.sevenmirror", firstPayload.second.notificationUpsert.sourceApplicationId)
